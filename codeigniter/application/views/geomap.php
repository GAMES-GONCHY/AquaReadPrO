<div id="content" class="app-content p-0 position-relative">
	...
	<div class="app-content-padding position-relative">
		...
		<h1 class="page-header text-white">Google Map <small class="text-white-transparent-5">header small text
				goes here...</small></h1>

		<div class="d-flex">
			<div class="btn-group map-btn ms-auto">
				<button type="button" class="btn btn-inverse" id="map-theme-text">Default Theme</button>
				<button type="button" class="btn btn-inverse dropdown-toggle" data-bs-toggle="dropdown"><b
				...
				<div class="dropdown-menu dropdown-menu-end" id="map-theme-selection">
					...
					<a href="javascript:;" data-map-theme="turquoise-water" class="dropdown-item">Turquoise
						Water</a>
